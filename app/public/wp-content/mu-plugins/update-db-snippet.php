<?php
// MU Plugin to update snippet and self-destruct
add_action('init', function() {
    if (get_option('__update_snippet_14_done') == '1') return;
...
EOT;
    ...
    $wpdb->update($table_name, ['code' => $new_code], ['id' => 14]);
    delete_transient('code_snippets');
    delete_transient('code_snippets_active_snippets');
    update_option('__update_snippet_14_done', '1');
});
