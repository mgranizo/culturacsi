<?php
/**
 * Handles Batch CSV export. This is a near copy from the woocommerce csv exporter.
 *
 * @package  Kadence Blocks Pro
 */

//phpcs:disable WordPress.PHP.NoSilencedErrors.Discouraged, WordPressVIPMinimum.Performance.FetchingRemoteData.FileGetContentsUnknown, WordPressVIPMinimum.Functions.RestrictedFunctions.file_ops_file_put_contents, WordPressVIPMinimum.Functions.RestrictedFunctions.chmod_chmod, WordPressVIPMinimum.Functions.RestrictedFunctions.file_ops_unlink
 ...
 */
if ( ! class_exists( 'KB_CSV_Exporter', false ) ) {
	require_once KBP_PATH . 'includes/form/admin/export/abstract-kb-csv-exporter.php';
}

/**
 * KB_CSV_Exporter Class.
 */
abstract class KB_CSV_Batch_Exporter extends KB_CSV_Exporter {
	...
	public function get_percent_complete() {
		return absint( $this->total_rows ? floor( ( $this->get_total_exported() / $this->total_rows ) * 100 ) : 100 );
	}
}
