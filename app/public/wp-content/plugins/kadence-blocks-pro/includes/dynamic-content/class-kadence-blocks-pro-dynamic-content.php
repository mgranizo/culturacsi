			...
			if ( ! empty( $blockattr ) ) {
				if ( isset( $blockattr['kadenceDynamic'] ) && is_array( $blockattr['kadenceDynamic'] ) && isset( $blockattr['kadenceDynamic']['images'] ) && is_array( $blockattr['kadenceDynamic']['images'] ) && isset( $blockattr['kadenceDynamic']['images']['enable'] ) && $blockattr['kadenceDynamic']['images']['enable'] ) {
					...
					if ( $update ) {
						...
						$slider_fade  = ( ! empty( $blockattr['slideType'] ) && 'fade' == $blockattr['slideType'] );
						...
						$arrow_position     = ! empty( $blockattr['arrowPosition'] ) ? $blockattr['arrowPosition'] : 'center';
						...
						$show_pause_button = ( ! empty( $blockattr['showPauseButton'] ) && $blockattr['showPauseButton'] ? true : false );
						if ( 'slider' === $type && is_array( $update ) && 1 === count( $update ) ) {
							$arrow_style = 'none';
							//$dot_style   = 'none';
						}
