 ...
 */
namespace KadenceWP\KadenceBlocksPro\enshrined\svgSanitize\ElementReference;
...
class Subject
{
     ...
     * @return bool
     * @throws \KadenceWP\KadenceBlocksPro\enshrined\svgSanitize\Exceptions\NestingException
     */
    public function hasInfiniteLoop(array $subjects = [], $level = 1)
    {
        if ($level > $this->useNestingLimit) {
            throw new \KadenceWP\KadenceBlocksPro\enshrined\svgSanitize\Exceptions\NestingException('Nesting level too high, aborting', 1570713498, null, $this->getElement());
        }
