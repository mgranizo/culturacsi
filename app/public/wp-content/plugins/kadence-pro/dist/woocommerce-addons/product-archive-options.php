...
$widget_settings = array(
	...
	'product_filter_widget_link_colors' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#filter-drawer .drawer-inner .product-filter-widgets a:not(.kb-button)',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '#filter-drawer .drawer-inner .product-filter-widgets a:hover:not(.kb-button)',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
