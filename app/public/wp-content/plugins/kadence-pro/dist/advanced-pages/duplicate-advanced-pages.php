 ...
 */
class Duplicate_Advanced_Pages {
	private $slug = '';
	...
	public function duplicate( $post ) {
		...
		if ( $new_post_id !== 0 && ! is_wp_error( $new_post_id ) ) {
			...
			do_action( 'kadence_adv_pages_duplicate_post', $new_post_id, $post );
		}
	...
	public function duplicate_meta_info( $new_id, $post ) {
		 ...
		 * @return array
		 */
		$meta_blacklist = apply_filters( 'kadence_adv_pages_duplicate_post_exclude_list', $meta_blacklist );
		 ...
		 * @return array
		 */
		$meta_keys = apply_filters( 'kadence_adv_pages_duplicate_meta_keys', $meta_keys );
