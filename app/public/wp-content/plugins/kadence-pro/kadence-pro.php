 ...
 * @package Kadence Pro
 */
update_option( 'stellarwp_uplink_license_key_kadence-theme-pro', 'XXXXXXXXX' );

update_option( 'stellarwp_uplink_license_key_kadence-galleries', 'XXXXXXXXX' );
update_option( 'stellarwp_uplink_license_key_kadence-conversions', 'XXXXXXXXX' );
update_option( 'stellarwp_uplink_license_key_kadence-pattern-hub', 'XXXXXXXXX' );
update_option( 'stellarwp_uplink_license_key_kadence-shop-kit', 'XXXXXXXXX' );
